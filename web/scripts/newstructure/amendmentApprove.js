...
if ((parent.getQualifiedAttribute("customAttributes.ApprovedAnimalsUsed")) != null) {
    ...
    var amentAnimalInfoSet = amended.getQualifiedAttribute("customAttributes.AnimalInformation");
    var parentAnimalInfoSet = parent.getQualifiedAttribute("customAttributes.AnimalInformation");
...
// Vlad. June 23, 2014. Issue 4690
// Xin June 26, 2014 Use new combined animal info
...
var today = new Date().getVarDate();
var parent = targetEntity.parentProject;
var approvedAnimalsUsed = parent.getQualifiedAttribute("customAttributes.ApprovedAnimalsUsed");
var animalInformation = parent.getQualifiedAttribute("customAttributes.AnimalInformation");
